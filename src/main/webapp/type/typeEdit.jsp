  ...
  <body>
	...
	<table style="width:500px; margin:0 auto;" class="table_border table_padding10">
		...
		<tr>
			<td>分类名称</td>
			<td class="left">
				<input type="text" name="typeName" value="${ type.typeName }" maxlength="45">&ensp;
				<span class="msg">*</span>
			</td>
		</tr>
		<tr>
		...
		<tr height="40">
			<td colspan="2" style="padding-left:100px; font-size:small;">			
				...
				&emsp;&emsp;
				<a href="typeShow?typeId=${ type.typeId }">返回分类详情页</a>
			</td>
		</tr>
	</table>
	</c:if>
...
function ajax() {
	var typeName 	= $("[name='typeName']").val();			//根据name获取输入的值
	var note 		= $("[name='note']").val();

	var url = "typeEditDo?typeId=${ type.typeId }";			//****目标地址
	var arg = {	"typeName" 	: typeName, 	"note" : note };//JSON格式数据： {key:value, k2:v2}
