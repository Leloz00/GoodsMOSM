  ...
  <body >		<!-- //####【新添代码】 -->	<!-- 为了实现按回车键也能提交表单 -->
	...
	<!-- //####【新添代码】：页头 -->
   	...
   	<div style="width:250px; margin:0 auto; text-align:left;">
	   	...
	   	<br>
	   	密&emsp;码：<input type="password" name="password" style="width:150px;">
		<br>		
...
//####【新添代码】						//网页转载、后退时，将刷新验证码图片

function codeChange() {											//刷新验证码图片
	
	var t = (new Date()).getTime();								//将当前时间转换为毫秒
	//####【新添代码】					//【重要】设置属性src的值。添加时间参数为了能刷新图片
	//####【新添代码】					//清空验证码输入框
	//####【新添代码】					//验证码输入框获得输入焦点，插入光标定位在验证码输入框中
}
